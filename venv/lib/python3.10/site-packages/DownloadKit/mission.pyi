...
class MissionData(object):
    ...
    def __init__(self, url: str, save_path: Union[str, Path], rename: Optional[str], suffix: Optional[str],
...
class Mission(BaseTask):
    ...
    def __init__(self, ID: int, download_kit: DownloadKit, file_url: str, save_path: Union[str, Path], rename: str,
